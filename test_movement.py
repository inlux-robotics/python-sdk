...
def Testmovements(robot):
    ...
    transition1 = [32.975, -139.175, 125.966, -116.484, -91.014, -122.857]


    point1 = [32.975, -172.175, 125.966, -116.484, -91.014, -122.857]
    point2 = [32.975, -172.175, 89.931, -116.484, -91.014, -122.857]
    point3 = [32.975, -172.175, 89.931, -50.484, -91.014, -122.857]

    #use the joints
    robot.MoveJ(p1Joint, 0, 0, vel=50.0)
    robot.MoveJ(p2Joint, 0, 0, vel=50.0)
    robot.MoveJ(p3Joint, 0, 0, vel=50.0)
    time.sleep(1)
    robot.MoveJ(transition1, 0, 0, vel=50.0)


    

    robot.MoveL(p1Joint, 0, 0, vel=100.0, blendR=20.0, blendMode=0)
    robot.MoveL(p2Joint, 0, 0, vel=100.0, blendR=20.0, blendMode=0)
    robot.MoveL(p3Joint, 0, 0, vel=100.0, blendR=20.0, blendMode=0)
    time.sleep(1)

    robot.MoveJ(point1, 0, 0, vel=50.0)
    robot.MoveJ(point2, 0, 0, vel=50.0)
    robot.MoveJ(point3, 0, 0, vel=50.0)
